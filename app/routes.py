...
def quiz_alt():
    ...
    if userTest.question == 'end':
        current_user.ecological = (userTest.result_food + userTest.result_recykle)/26
        db.session.commit()    
        return redirect(url_for('company', companyname=current_user.username))
